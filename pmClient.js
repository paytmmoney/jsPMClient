    ...
    this.get_live_market_data = function(mode_type, prefrences){
        ...
        response = apiservice.apiCall('live_market_data','GET',null,null,path_params).then(
            function(response){
                ...
                for (var market_data in response['data']) {
                    if (response['data'][market_data]['last_trade_time'] != null) {
                        response['data'][market_data]['last_trade_time'] = utils.EpochConverter(response['data'][market_data]['last_trade_time'])
                    }
                    if (response['data'][market_data]['last_update_time'] != null) {
                        response['data'][market_data]['last_update_time'] = utils.EpochConverter(response['data'][market_data]['last_update_time'])
                    }
                }
