...
var PMClient  = function(api_key, api_secret, access_token=null, public_access_token=null, read_access_token=null){
    ...
    */
     ...
     * @param {String} triggered_at_type
     */
    this.create_gtt_v2 = function(segment, exchange, pml_id, security_id, product_type, set_price, transaction_type, order_type, trigger_type, quantity, trigger_price, limit_price){
        var transaction_details = []
     ...
     * @param {String} limit_price
     */
    this.update_gtt_v2 = function(id,set_price=null, transaction_type=null, order_type=null, trigger_type=null, quantity=null, trigger_price=null, limit_price=null){
        var path_params = {
            'id' : id
        }
    ...
    this.get_gtt_by_instruction_id_v2 = function(id){
        ...
        return apiservice.apiCall(endpoints.gtt_by_instruction_id_v2[0],endpoints.gtt_by_instruction_id_v2[1],'GET',null,null,path_params)
    }
