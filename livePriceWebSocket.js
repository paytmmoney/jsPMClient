    ...
    parseBinary(packet) {
            ...
            function processQuotePacket() {
                response.push({
                    ...
                    volume_traded: dvu.getBigInt64(position + 22, true),
            ...
            function processFullPacket() {
                ...
                tick.volume_traded = dvu.getBigInt64(position + 22, true), 
                ...
                tick.OI = dvu.getBigInt64(position + 66, true),
                tick.OI_change = dvu.getBigInt64(position + 70, true)
